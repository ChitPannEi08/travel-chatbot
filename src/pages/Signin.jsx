...
const s = {
    ...
    signupLink: { color: "#8a66f4ff", fontWeight: 500, textDecoration: "none" },
};
...
export default function Signin() {
    ...
    const handleSubmit = async (e) => {
        ...
        const { success, error: err } = await signInUser(email, password);
        setLoading(false);
    ...
    return (
        <div style={s.container}>
                ...
                <form style={s.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <div style={s.formGroup}>
                        ...
                        <div style={s.inputWrap}>
                            <svg style={s.inputIcon} width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                <rect x="2" y="4" width="20" height="16" rx="3" stroke="#282727ff" strokeWidth="2" />
                                <path d="M2 8l10 6 10-6" stroke="#282727ff" strokeWidth="2" strokeLinecap="round" />
                            </svg>
                            <input
                                id="si-email"
                                type="email"
                    ...
                    <div style={s.formGroup}>
                        <div style={s.labelRow}>
                            <label htmlFor="si-password" style={s.label}>Password</label>
                        </div>
                        <div style={s.inputWrap}>
                            <svg style={s.inputIcon} width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <style>{`
                ...
                #si-email::placeholder,
                #si-password::placeholder { color: rgba(255,255,255,0.2); }
                #si-email:focus,
                #si-password:focus {
                    border-color: #7c3aed;
