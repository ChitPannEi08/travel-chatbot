...
const s = {
    ...
    signupLink: { color: "#a78bfa", fontWeight: 500, textDecoration: "none" },
};
                ...
                <div style={s.header}>
                    <div style={s.logoWrap}>
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" aria-hidden="true">
                            <rect width="36" height="36" rx="10" fill="url(#si-grad)" />
                            <path d="M10 18L16 24L26 12" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                            <defs>
                                <linearGradient id="si-grad" x1="0" y1="0" x2="36" y2="36" gradientUnits="userSpaceOnUse">
